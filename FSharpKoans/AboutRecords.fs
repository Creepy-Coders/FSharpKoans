...
module ``13: On the Record`` =
    ...
    let ``03 Decomposing with a record pattern`` () =
        ...
        let PublishYear = book.Year
        bookTitle |> should equal "Dune" // DO NOT use a . symbol in your answer
        PublishYear |> should equal 1965 // DO NOT use a . symbol in your answer
